...
# List of Fsec's photos
Fsecphoto = [
    "https://graph.org/file/cb9394eec3d0ebce858f9.jpg"

      "https://graph.org/file/5a7785d43a18ea2353dc9.jpg"

        "https://graph.org/file/424a208d9daaeead02e8b.jpg"
]
...
bg_path = "Fsecmusic/assets/Fsec/Fsec.png"
font_path = "Fsecmusic/assets/Fsec/Falconinf.ttf"
    ...
    if not message.reply_to_message and len(message.command) == 2:
        try:
            ...
            if user.photo:
                ...
                # User doesn't have a profile photo, use Fsecphoto directly
                welcome_photo = random.choice(Fsecphoto)
        ...
        try:
            ...
            if user.photo:
                ...
                # User doesn't have a profile photo, Fsecphoto directly
                welcome_photo = random.choice(Fsecphoto)
