...
from Fsecmusic.plugins.tools.pretenderdb import impo_off, impo_on, check_pretender, add_userdata, get_userdata, usr_data
...
""".format(
    ...
    if msg != "":
        await message.reply_photo("https://graph.org/file/5a7785d43a18ea2353dc9.jpg", caption=msg)
